...
ansible-pull -U https://github.com/devopswitharunkumar/roboshop-ansible-with-roles-for-CD-deploy-usage.git -e component=$component -e env=$environment -e app_version=$app_version main-tf.yaml
